...
export const SOL_COIN_ADDRESS = '11111111111111111111111111111111';
...
export const RONIN_COIN_ADDRESS = 'ronin:0000000000000000000000000000000000000000';
...
export const HEADER_PROTOCOL = 'x-defi-protocol';
