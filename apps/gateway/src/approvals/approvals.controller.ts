import { GetAllApprovalsDto } from 'apps/account/src/common/dto/GetAllApprovals.dto';
import { ApprovalsSortFieldsEnum } from 'apps/account/src/common/enum/ApprovalsSortFields.enum';
