...
export class AssetsServiceMigration61645025639200 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "assets_underlying" DROP CONSTRAINT "FK_11ded68334cd20858496add437b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "assets_underlying" DROP CONSTRAINT "FK_3bc7cf39d4f1c57a4a875503616"`,
    );
    await queryRunner.query(
