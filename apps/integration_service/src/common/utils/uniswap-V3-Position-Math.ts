...
// https://github.com/uniswap/v3-sdk/blob/b50b02238d4d4f04dbaa04d531e5ff8dd76d63d9/src/utils/full-math.ts#L10
...
// https://github.com/uniswap/v3-sdk/blob/b50b02238d4d4f04dbaa04d531e5ff8dd76d63d9/src/utils/sqrtPrice-math.ts#L25
...
// https://github.com/uniswap/v3-sdk/blob/b50b02238d4d4f04dbaa04d531e5ff8dd76d63d9/src/utils/sqrtPrice-math.ts#L38
...
// https://github.com/uniswap/v3-sdk/blob/b50b02238d4d4f04dbaa04d531e5ff8dd76d63d9/src/utils/tick-math.ts#L7
function mulShift(val: BN, mulBy: string): BN {
  return val.mul(new BN(mulBy)).shrn(128);
}

// https://github.com/uniswap/v3-sdk/blob/b50b02238d4d4f04dbaa04d531e5ff8dd76d63d9/src/utils/tick-math.ts#L41
