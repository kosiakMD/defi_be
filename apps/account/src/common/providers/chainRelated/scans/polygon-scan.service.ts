...
import { CACHE_MANAGER, HttpService, Inject, Injectable, OnModuleInit } from '@nestjs/common';
...
@Injectable()
export class PolygonScanService extends ScanApiService implements OnModuleInit {
  ...
  async onModuleInit() {
    this.chainId = await this.chainsService.getChainIdByName(ChainNameEnum.plg);
  }
}
