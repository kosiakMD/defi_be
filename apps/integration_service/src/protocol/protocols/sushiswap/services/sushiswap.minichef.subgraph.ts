...
import { getMiniChefPositionsQuery } from '../queries/minichef.query';
import { ISushiSwapMiniChef } from '../sushiswap.interfaces';
...
export class SushiSwapMiniChefSubgraph {
  ...
  constructor(
    ...
    this.subgraphUrls = new Map([
      [ChainIdEnum.plg, this.configService.get<string>('SUSHISWAP_PLG_MINICHEF_SUBGRAPH_URL')],
    ]);
  }
