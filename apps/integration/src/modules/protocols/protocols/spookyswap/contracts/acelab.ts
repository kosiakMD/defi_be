...
export const SPOOKYSWAP_ACELAB_MASTERCHEF_ABI: JsonFragment[] = [
  {
    inputs: [{ internalType: 'contract IERC20', name: '_xboo', type: 'address' }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: '_gemsPerSecond', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'TokenPrecision', type: 'uint256' },
      ...
      { internalType: 'uint256', name: 'userLimitEndTime', type: 'uint256' },
      { internalType: 'address', name: 'protocolOwnerAddress', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
