...
export const COIN_MARKET_CAP_LIST_URL =
  'https://pro-api.coinmarketcap.com/v1/cryptocurrency/map?sort=cmc_rank';
export const COIN_MARKET_CAP_API_KEY = '85aa61cf-1cf5-40da-88bd-b16d054cd865';
export const COIN_GECKO_COIN_PRICE_URL = 'https://api.coingecko.com/api/v3/simple/price';
