...
export const SPOOKYSWAP_XBOO_ABI: JsonFragment[] = [
  {
    inputs: [{ internalType: 'contract IERC20', name: '_boo', type: 'address' }],
  ...
  },
  {
    ...
    name: 'BOOForxBOO',
    outputs: [{ internalType: 'uint256', name: 'xBOOAmount_', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
