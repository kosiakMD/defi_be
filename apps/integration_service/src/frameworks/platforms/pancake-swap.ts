...
import { CakeVault, ICakeVaultMeta } from '../support/evm/protocols/yield/cake-vault';
import { IMasterChefMeta, MasterChef } from '../support/evm/protocols/yield/master-chef';
import { MasterChefPancakeV2 } from '../support/evm/protocols/yield/master-chef-pancake-v2';
import { StakingRewards } from '../support/evm/protocols/yield/staking-rewards';
