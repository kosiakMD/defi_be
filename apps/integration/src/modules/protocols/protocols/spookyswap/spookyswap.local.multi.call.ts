...
import {
  ...
  xBooAbis,
  xBooMap,
} from './helpers/multicall.helpers';
import { AceLabUser, MasterchefUser } from './spookyswap';
import { Claimable } from './spookyswap/claimable.interfaces';

export class SpookyswapLocalMultiCall extends MultiCall {
