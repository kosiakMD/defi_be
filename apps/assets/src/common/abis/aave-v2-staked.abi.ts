...
export const AAVE_V2_STAKED_ABI: AbiItem[] = [
  {
    inputs: [
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'fromCooldownTimestamp', type: 'uint256' },
      { internalType: 'uint256', name: 'amountToReceive', type: 'uint256' },
