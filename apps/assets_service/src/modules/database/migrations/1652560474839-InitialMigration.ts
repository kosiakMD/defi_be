...
export class InitialMigration1652560474839 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "assets_historical_prices" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "timestamp" TIMESTAMP NOT NULL, "open" numeric NOT NULL, "high" numeric NOT NULL, "low" numeric NOT NULL, "close" numeric NOT NULL, "ticks" integer NOT NULL, "asset_id" integer NOT NULL, CONSTRAINT "UQ_38a7e89481a81c5b57e4942921e" UNIQUE ("asset_id", "timestamp"), CONSTRAINT "PK_c86b1926f204233b410a217a300" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
