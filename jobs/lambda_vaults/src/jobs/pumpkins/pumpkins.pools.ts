...
@Injectable()
export class PumpkinsPools implements JobInterface {
  chain = ChainIdEnum.ftm;
  feature = FeatureEnum.pools;
  protocol = ProtocolNameEnum.pumpkins;
  ...
  poolInfoLabel(poolId) {
    return concatStrings(Abis.poolInfo.name, PumpkinsAddresses.chief, poolId);
  }
