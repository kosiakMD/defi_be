...
export const CURVE_REGISTRY_ABI: AbiItem[] = [
  {
    name: 'PoolAdded',
    inputs: [
      { name: 'pool', type: 'address', indexed: true },
      { name: 'rate_method_id', type: 'bytes', indexed: false },
    ],
    anonymous: false,
    type: 'event',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_gauge_controller', type: 'address' },
    ],
    outputs: [],
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'future_fee', type: 'uint256' },
      { name: 'future_admin_fee', type: 'uint256' },
      { name: 'future_owner', type: 'address' },
      { name: 'initial_A', type: 'uint256' },
      { name: 'initial_A_time', type: 'uint256' },
      { name: 'future_A_time', type: 'uint256' },
    ],
    gas: 6305,
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_rate_info', type: 'bytes32' },
      { name: '_decimals', type: 'uint256' },
      { name: '_underlying_decimals', type: 'uint256' },
      { name: '_has_initial_A', type: 'bool' },
      { name: '_is_v1', type: 'bool' },
  ...
  },
  {
    ...
    inputs: [
      { name: '_addr', type: 'address[5]' },
      { name: '_amount', type: 'uint256[2][5]' },
    ],
    outputs: [],
    gas: 390460,
  },
  {
    ...
    inputs: [
      { name: '_addr', type: 'address[10]' },
      { name: '_amount', type: 'uint256[10]' },
    ],
    outputs: [],
    gas: 392047,
  },
