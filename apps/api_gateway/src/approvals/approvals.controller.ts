import { GetAllApprovalsDto } from 'apps/account_service/src/common/dto/get-all-approvals.dto';
import { ApprovalsSortFieldsEnum } from 'apps/account_service/src/common/enum/approvals-sort-fields.enum';
