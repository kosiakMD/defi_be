...
export const ONE_DAY_SECONDS: number = 86400
export const TIMESTAMP_DAY_BEFORE_CURRENT: number = Math.trunc(TIMESTAMP_CURRENT - ONE_DAY_SECONDS)
export const TIMESTAMP_WEEK_BEFORE_CURRENT: number = Math.trunc(TIMESTAMP_CURRENT - ONE_DAY_SECONDS * 7)
export const TIMESTAMP_MONTH_BEFORE_CURRENT: number = Math.trunc(TIMESTAMP_CURRENT - ONE_DAY_SECONDS * 30)
