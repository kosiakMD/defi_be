...
export interface ISupplyTokenMinimal<TExtra = unknown> extends ITokenMinimal<TExtra> {
  weight?: string;
...
export interface ISupplyTokenOpportunity<TExtra = unknown> extends ITokenOpportunity<TExtra> {
  weight?: number;
