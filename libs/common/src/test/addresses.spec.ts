...
const validCardanoAddress =
  'addr1q928gwvx5edmku48ry292r0e7zlmky4q5tspkm0xdtrh7lcxauguwlr9f5rjnz5a7hdchspnsafgdsypqam4dncpveeq30llfw';
...
describe('keep addresses by chain id should', () => {
  ...
  it('Remove non - valid evm address', () => {
    const result = keepAddressesByChainId(
      validEvmAddress + ',' + validCardanoAddress,
      ChainIdEnum.eth,
    );
  ...
  it('Remove non - valid solana address', () => {
    const result = keepAddressesByChainId(
      validEvmAddress + ',' + validSolanaAddress,
      ChainIdEnum.sol,
    );
  ...
  it('Remove non - valid terra address', () => {
    const result = keepAddressesByChainId(
      validEvmAddress + ',' + validTerraAddress,
      ChainIdEnum.terra,
    );
  ...
  it('Remove non - valid cosmos address', () => {
    const result = keepAddressesByChainId(
      validEvmAddress + ',' + validCosmosAddress,
      ChainIdEnum.cosmos,
    );
  ...
  it('Remove non - valid kava address', () => {
    const result = keepAddressesByChainId(
      validEvmAddress + ',' + validKavaAddress,
      ChainIdEnum.kava,
    );
  ...
  it('Remove non - valid osmosis address', () => {
    const result = keepAddressesByChainId(
      validEvmAddress + ',' + validOsmosisAddress,
      ChainIdEnum.osmosis,
    );
  ...
  it('Remove non - valid secret address', () => {
    const result = keepAddressesByChainId(
      validEvmAddress + ',' + validSecretAddress,
      ChainIdEnum.secret,
    );
  ...
  it('Remove non - valid ronin address', () => {
    const result = keepAddressesByChainId(
      validEvmAddress + ',' + validRoninAddress,
      ChainIdEnum.ronin,
    );
