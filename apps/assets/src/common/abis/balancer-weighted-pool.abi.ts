...
export const BALANCER_WEIGHTED_POOL_ABI: AbiItem[] = [
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    inputs: [],
    name: 'bFactory',
    outputs: [{ internalType: 'contract IBFactory', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'minimumWeightChangeBlockPeriodParam', type: 'uint256' },
      { internalType: 'uint256', name: 'addTokenTimeLockInBlocksParam', type: 'uint256' },
    ],
    name: 'createPool',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'enum RightsManager.Permissions', name: 'permission', type: 'uint8' }],
    name: 'hasPermission',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'view',
    type: 'function',
    ...
    inputs: [
      { internalType: 'address', name: 'factoryAddress', type: 'address' },
      {
        components: [
          ...
          { internalType: 'address[]', name: 'constituentTokens', type: 'address[]' },
          { internalType: 'uint256[]', name: 'tokenBalances', type: 'uint256[]' },
          { internalType: 'uint256[]', name: 'tokenWeights', type: 'uint256[]' },
  ...
  { inputs: [], name: 'pokeWeights', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [
