...
import { AstroportAddresses } from '../astroport/addresses';
import { AstroportGraph } from '../astroport/astroport.graph';
...
@Injectable()
export class MirrorStaking implements JobInterface {
  chain = ChainIdEnum.terra;
  feature = FeatureEnum.staking;
  protocol = ProtocolNameEnum.mirror;
