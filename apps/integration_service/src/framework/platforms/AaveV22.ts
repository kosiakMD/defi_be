...
import { AaveV2Lending, IAaveV22Meta } from '../support/EVM/protocols/Lending/AaveV2Lending';
import { RootPlatform } from '../support/RootPlatform';
import { FeatureEnum } from '../support/enums';

export class AaveV22 extends RootPlatform {
  constructor(
  ...
  async register(): Promise<void> {
    ...
    await this.registerProtocol<IAaveV22Meta>(AaveV2Lending, {
