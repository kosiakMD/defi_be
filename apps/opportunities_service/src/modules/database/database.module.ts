...
import { FarmEntity } from '../opportunity/entities/farm.entity';
import { OpportunityEntity } from '../opportunity/entities/opportunity.entity';
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => {
        return {
          ...
          entities: [FarmEntity, OpportunityEntity],
