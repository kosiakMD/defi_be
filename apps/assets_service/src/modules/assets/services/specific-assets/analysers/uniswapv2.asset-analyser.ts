import { AssetReference } from 'apps/assets_service/src/common/types';
...
import { EVMAssetAnalyser } from './common/evm.asset-analyser';
...
{
  constructor(multicall: MulticallAggregator) {
    super(multicall);
  }
