...
import { DefiSwapLiquidity } from '../support/EVM/protocols/Liquidity/CryptoComDefiSwapLiquidity';
import { DefiSwapLocked } from '../support/EVM/protocols/Locked/CryptoComDefiSwapLocked';
...
export class CryptoComDefiswap extends RootPlatform {
  ...
  async register() {
    ...
    await this.registerProtocol(DefiSwapLocked, {
      chain: ChainIdEnum.eth,
      name: 'Locked - CryptoComDefiswap - 1 year',
    ...
    await this.registerProtocol(DefiSwapLocked, {
      chain: ChainIdEnum.eth,
      name: 'Locked - CryptoComDefiswap - 2 years',
      feature: FeatureEnum.lockedBalances,
    ...
    await this.registerProtocol(DefiSwapLocked, {
      chain: ChainIdEnum.eth,
      name: 'Locked - CryptoComDefiswap - 3 years',
      feature: FeatureEnum.lockedBalances,
    ...
    await this.registerProtocol(DefiSwapLocked, {
      chain: ChainIdEnum.eth,
      name: 'Locked - CryptoComDefiswap - 4 years',
      feature: FeatureEnum.lockedBalances,
