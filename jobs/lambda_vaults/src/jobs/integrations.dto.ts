...
import { NotifyBase, NotifySupportedFeature } from '@app/common/jobs/notify.dto';
...
export class NotifyPayloadFeaturesDto implements NotifyBase<NotifySupportedFeature> {
  chain: ChainIdEnum;
  protocolName: ProtocolName;
  featureName: FeatureName;
  items: NotifySupportedFeature[];
}
