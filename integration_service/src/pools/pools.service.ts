...
export class PoolsService {
  private minReserveUdsToDisplay: number = 1000000
  constructor(
    @InjectRepository(LiquidityPoolsEntity) private readonly liquidityPoolsRepository: LiquidityPoolsRepository,
  ) {
  }

  getPoolsToDisplay(): Promise<LiquidityPoolsEntity[]> {
    return this.liquidityPoolsRepository.createQueryBuilder('pools')
