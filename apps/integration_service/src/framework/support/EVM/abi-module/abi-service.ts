...
import { BlockScan } from './block-scan.service';
import { BlockScout } from './block-scout.service';
import { LocalFile } from './local-file.service';
    ...
    const target = web.utils.numberToHex(
      web.utils.hexToNumberString(
        await web.eth.getStorageAt(
          ...
          // False positive: https://snowtrace.io/address/0xb3c68d69E95B095ab4b33B4cB67dBc0fb-f3Edf56#readContract
